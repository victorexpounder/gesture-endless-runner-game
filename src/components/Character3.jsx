...
const Character3 = ({animationName = 'idle', ...props}) => {
  const { nodes, materials } = useGLTF('/models/humans/character3/character3.glb')
  const { animations: idleAnimation } =  useFBX('/models/humans/character3/idle.fbx')
  ...
  useEffect(()=>{
    ...
    actions[animationName].setLoop(1,1)
...
useGLTF.preload('/models/humans/character3/character3.glb')
