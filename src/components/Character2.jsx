...
const Character2 = ({animationName = 'idle', ...props}) => {
  const { nodes, materials } = useGLTF('/models/humans/character2/character2.glb')
  const { animations: idleAnimation } =  useFBX('/models/humans/character2/idle.fbx')
...
useGLTF.preload('/models/humans/character2/character2.glb')
